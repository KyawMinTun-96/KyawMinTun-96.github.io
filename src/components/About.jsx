...
function About() {
    ...
    return(
        <section id="about" className="my-info" data-aos-delay="500" data-aos="fade-up"
        data-aos-duration="3000">
            <h2 className="sec-title">About Me</h2>

            <div className="about">
                <div className="content" data-aos-delay="100" data-aos="fade-up-right" data-aos-duration="3000">
                    ...
                    <ul className="skills" data-aos-delay="200" data-aos="zoom-in" data-aos-duration="3000">
                    {
                        loadSkills(pName)
                    }
                    </ul>
                </div>
                <div className="profile" data-aos-delay="200" data-aos="fade-up-left" data-aos-duration="3000">
